...
//Result names
#define RES_COM_ID "d:ID"
#define RES_COM_TITLE "d:Title"
...
#define RES_IMAGE_THUMBNAIL "d:Thumbnail"
#define RES_IMAGE_SOURCE_URL "d:SourceUrl"

#define RES_NEWS_DESCRIPTION "d:Description"
#define RES_NEWS_URL "d:Url"
#define RES_NEWS_DATE "d:Date"
#define RES_NEW_SOURCE "d:Source"

#define RES_RELATED_BING_URL "d:BingUrl"

#define RES_SPELL_VALUE "d:Value"

#define RES_VIDEO_RUN_TIME_LENGTH "d:RunTime"

#define RES_WEB_DISPLAY_URL "d:DisplayUrl"
...
{
		//Common
		{{BING_RESULT_FIELD_ID,					FIELD_TYPE_STRING,	RES_COM_ID,					6,	{BING_SOURCETYPE_IMAGE, BING_SOURCETYPE_NEWS,
				BING_SOURCETYPE_RELATED_SEARCH, BING_SOURCETYPE_VIDEO, BING_SOURCETYPE_WEB, BING_SOURCETYPE_SPELL}},									&result_fields[1]},
		{{BING_RESULT_FIELD_TITLE,				FIELD_TYPE_STRING,	RES_COM_TITLE,				5,	{BING_SOURCETYPE_IMAGE, BING_SOURCETYPE_NEWS,
		...
		{{BING_RESULT_FIELD_THUMBNAIL,			FIELD_TYPE_ARRAY,	RES_IMAGE_THUMBNAIL,		2,	{BING_SOURCETYPE_IMAGE, BING_SOURCETYPE_VIDEO}},	&result_fields[8]},
		{{BING_RESULT_FIELD_SOURCE_URL,			FIELD_TYPE_STRING,	RES_IMAGE_SOURCE_URL,		1,	{BING_SOURCETYPE_IMAGE}},							&result_fields[9]},

		//News
		{{BING_RESULT_FIELD_DESCRIPTION,		FIELD_TYPE_STRING,	RES_NEWS_DESCRIPTION,		2,	{BING_SOURCETYPE_NEWS, BING_SOURCETYPE_WEB}},		&result_fields[10]},
		{{BING_RESULT_FIELD_URL,				FIELD_TYPE_STRING,	RES_NEWS_URL,				2,	{BING_SOURCETYPE_NEWS, BING_SOURCETYPE_WEB}},		&result_fields[11]},
		{{BING_RESULT_FIELD_DATE,				FIELD_TYPE_LONG,	RES_NEWS_DATE,				1,	{BING_SOURCETYPE_NEWS}},							&result_fields[12]},
		{{BING_RESULT_FIELD_SOURCE,				FIELD_TYPE_STRING,	RES_NEW_SOURCE,				1,	{BING_SOURCETYPE_NEWS}},							&result_fields[13]},

		//RelatedSearch
		{{BING_RESULT_FIELD_BING_URL,			FIELD_TYPE_STRING,	RES_RELATED_BING_URL,		1,	{BING_SOURCETYPE_RELATED_SEARCH}},					&result_fields[13]},

		//Spell
		{{BING_RESULT_FIELD_VALUE,				FIELD_TYPE_STRING,	RES_SPELL_VALUE,			1,	{BING_SOURCETYPE_SPELL}},							&result_fields[14]},

		//Video
		{{BING_RESULT_FIELD_RUN_TIME_LENGTH,	FIELD_TYPE_INT,		RES_VIDEO_RUN_TIME_LENGTH,	1,	{BING_SOURCETYPE_VIDEO}},							&result_fields[15]},

		//Web
		{{BING_RESULT_FIELD_DISPLAY_URL,		FIELD_TYPE_STRING,	RES_WEB_DISPLAY_URL,		3,	{BING_SOURCETYPE_IMAGE, BING_SOURCETYPE_VIDEO,
